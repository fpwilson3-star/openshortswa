...
- No hashtag-spam. Hashtags are allowed ONLY on Instagram (up to 3) and TikTok (3–4), lowercase, genuinely relevant. NEVER use #fyp, #foryou, #foryoupage, or #viral on any platform — generic reach-tags are dead weight and signal low-effort content.
...
PLATFORM SPECIFICS:
- video_description_for_tiktok: ONE short punchy line, ≤120 characters, conversational. FRONT-LOAD the clip's searchable keywords in that line — TikTok indexes captions for search, and search traffic keeps paying off long after feed distribution fades. When it fits naturally, end the line with a genuine, specific question the clip provokes (specific questions drive real comments; skip it rather than forcing "what do you think?" filler). Then a final line of 3–4 niche, clip-specific lowercase hashtags per the hashtag rule above (e.g. #cortisol #hormonehealth — never #fyp).
